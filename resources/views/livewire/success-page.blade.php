        ...
        <div
            ...
            <div>
                <h1 class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-300 ">
                    Спасибо. Ваш заказ был оформлен. </h1>
                <div
                    ...
                    <div class="flex items-start justify-start flex-shrink-0">
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                ...
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">Телефон:
                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            Метод оплаты: </p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
                            {{ $order->payment_method == 'cod' ? 'Оплата при получении' : 'Перевод по реквизитам' }} </p>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Промежуточный итог</p>
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <p class="text-base font-semibold leading-4 text-gray-600 dark:text-gray-400">
                                    {{ Number::currency($order->grand_total, 'RUB') }}
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div class="flex flex-col items-center justify-start">
                                        <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                                            Доставка<br><span class="text-sm font-normal">Доставка за 24 часа</span>
                                        </p>
                                    </div>
                                </div>
                                <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
