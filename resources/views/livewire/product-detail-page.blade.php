            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        ...
                        <div class="w-32 mb-8 ">
                            <label for=""
                                   class="w-full pb-1 text-xl font-semibold text-gray-700 border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">Количество</label>
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='addToCart({{ $product->id }})'
                                ...
                                <span wire:loading wire:target='addToCart({{ $product->id }})'>Добавляется..</span>
                            </button>
                        </div>
                    </div>
                </div>
